...
export const MAP_SCENE_GLBS = {
  ...
  expanded: require("../assets/game/map-3d/world-map-expanded.glb"),
} as const;

/** Canonical territory-name atlas shared by web and native R3F scenes. */
export const MAP_SCENE_LABEL_ATLAS = require("../assets/game/map-3d/territory-labels.png");
